...
def initializeParamteres():
    ...
    deltaHiddenLayer1 = np.random.uniform(low=0, high=1, size=(numberOfNeuronsInHiddenLayer,2))
    ...
    deltaHiddenLayer2 = np.random.uniform(low=0, high=1, size=(numberOfNeuronsInHiddenLayer,numberOfNeuronsInHiddenLayer))

    # This is the weight of the ouput neuron.
    wOutputLayer = np.random.uniform(low=0, high=1, size=(numberOfNeuronsInHiddenLayer,1))
    deltaOutputLayer = np.random.uniform(low=0, high=1, size=(numberOfNeuronsInHiddenLayer,1))
    ...
    return wHiddenLayer1, wHiddenLayer2, wOutputLayer, weightedSumH1, weightedSumH2, weightedSumOp,             bHiddenLayer1, bHiddenLayer2, activationH1, activationH2, bOutputLayer, deltaHiddenLayer1,             deltaHiddenLayer2, deltaOutputLayer
...
def backPropogate(ouput, sample, wHiddenLayer1, wHiddenLayer2, wOutputLayer, weightedSumH1, weightedSumH2,weightedSumOp, 
                  bHiddenLayer1, bHiddenLayer2, activationH1, activationH2, bOutputLayer, LR, psy, deltaHiddenLayer1,
    ...
    for rowIndex in range(len(wOutputLayer)):
        ...
        deltaOutputLayer[rowIndex][0] = (psy*deltaOutputLayer[rowIndex][0]) + totalCalcDerivate
    ...
    for rowIndex in range(len(wHiddenLayer2)):
        ...
        for colIndex in range(len(wHiddenLayer2[rowIndex])):
            ...
            deltaHiddenLayer2[colIndex][rowIndex] = (psy * deltaHiddenLayer2[colIndex][rowIndex]) + totalCalcDerivate
            deltaForBias += totalCalcDerivate
            wHiddenLayer2[colIndex][rowIndex] -= (LR * deltaHiddenLayer2[colIndex][rowIndex])
    ...
    for rowIndex in range(len(wHiddenLayer1)):
        ...
        for colIndex in range(len(wHiddenLayer1[rowIndex])):
            ...
            deltaHiddenLayer1[rowIndex][colIndex] = (psy * deltaHiddenLayer1[rowIndex][colIndex]) + totalCalcDerivate
            deltaForBias += totalCalcDerivate
            wHiddenLayer1[rowIndex][colIndex] -= (LR * deltaHiddenLayer1[rowIndex][colIndex])
        bHiddenLayer1[rowIndex][0] -= (LR * deltaForBias)

    return wHiddenLayer1, wHiddenLayer2, wOutputLayer, bHiddenLayer1, bHiddenLayer2, bOutputLayer, LR, psy, deltaHiddenLayer1,             deltaHiddenLayer2, deltaOutputLayer
...
def startNNTraining(trainingSet, validationSet, standardizedTestSet):
    ...
    wHiddenLayer1, wHiddenLayer2, wOutputLayer, weightedSumH1, weightedSumH2, weightedSumOp, bHiddenLayer1,         bHiddenLayer2, activationH1, activationH2, bOutputLayer, deltaHiddenLayer1 ,deltaHiddenLayer2,         deltaOutputLayer = initializeParamteres()
        ...
        for iteration in range(epochs):
            ...
            if validationIterationCount == 250:
                ...
                for randomIndex in randomIndicesForSGD:
                    ...
                    wHiddenLayer1, wHiddenLayer2, wOutputLayer, weightedSumH1, weightedSumH2, weightedSumOp,                     activationH1, activationH2, output, error = feedForward(trainingSet[randomIndex], wHiddenLayer1, wHiddenLayer2, 
                                                                            wOutputLayer, weightedSumH1, weightedSumH2, weightedSumOp, 
                                                                            bHiddenLayer1, bHiddenLayer2, activationH1, activationH2, 
                                                                            bOutputLayer)
                    ...
                    wHiddenLayer1, wHiddenLayer2, wOutputLayer, bHiddenLayer1, bHiddenLayer2,bOutputLayer, LR, psy,                     deltaHiddenLayer1, deltaHiddenLayer2, deltaOutputLayer =                         backPropogate(output, trainingSet[randomIndex], wHiddenLayer1, wHiddenLayer2, wOutputLayer,
                                      weightedSumH1, weightedSumH2, weightedSumOp, bHiddenLayer1, bHiddenLayer2, 
                                      activationH1, activationH2, bOutputLayer,LR, psy, deltaHiddenLayer1, 
                                      deltaHiddenLayer2, deltaOutputLayer)
...
def main():
    ...
    valList, LRList, PsyList, BestValScore = startNNTraining(trainingSet, validationSet, standardizedTestSet);
    ...
    plt.title('Learning Rate vs Validation Error vs Psy Values')
    plt.show()
